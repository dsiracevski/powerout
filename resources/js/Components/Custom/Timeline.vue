...
<template>
  ...
  <div
      class="md:max-w-4xl lg:max-w-7xl lg:min-w-7xl min-w-[332px] mx-auto px-4 md:px-6 bg-gray-100 dark:bg-gray-300 shadow-lg rounded-2xl shadow-cyan-400 border-2 border-cyan-400 divide-y-2 divide-solid divide-[#C9E6F0] overflow-auto lg:min-w-[896px]">
    <FilterGroup/>
