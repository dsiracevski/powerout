...
<template>
  <div class="md:mt-24 mt-6 md:self-end space-y-1">
    <p>Have a suggestion?</p>
    <div class="flex flex-row gap-3">
      <p>You can find me here:</p>
      <div class="flex flex-row gap-2">
        <a href="https://github.com/dsiracevski" target="_blank">
          <svg width="24px" height="24px" viewBox="0 -3.5 256 256" xmlns="http://www.w3.org/2000/svg"
        ...
        <a href="https://www.linkedin.com/in/dsiracevski/" target="_blank">
          <svg width="24px" height="24px" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
            ...
            <g
                id="SVGRepo_iconCarrier"> <circle style="fill:#4A86C5;" cx="236.966" cy="236.966"
                                                  r="236.966"></circle>
              <path style="fill:#3D80B2;"
                    d="M404.518,69.383c92.541,92.549,92.549,242.59,0,335.138c-92.541,92.541-242.593,92.541-335.134,0 L404.518,69.383z"></path>
              <path style="fill:#4A86C5;"
                    d="M462.646,309.275c0.868-2.713,1.658-5.456,2.432-8.206 C464.307,303.823,463.496,306.562,462.646,309.275z"></path>
              <g> <polygon style="fill:#377CA5;"
                           points="465.097,301.017 465.097,301.017 465.082,301.07 "></polygon>
                <path style="fill:#377CA5;"
                      d="M465.097,301.017L336.721,172.641l-29.204,29.204l-20.303-20.303l-16.946,16.946L171.032,99.25 l-6.155-2.346l-38.08,38.08l45.968,45.964l-44.998,44.995l43.943,43.943l-48.048,48.052L276.475,470.59 c87.984-14.78,159.5-77.993,186.175-161.311c0.849-2.716,1.658-5.452,2.432-8.206C465.082,301.055,465.09,301.032,465.097,301.017z "></path> </g>
        ...
        <a href="https://www.facebook.com/d.sirachevski" target="_blank">
        ...
        <a href="https://www.instagram.com/dsiracevski/" target="_blank">
        ...
        <a href="mailto:dsiracevski@gmail.com" target="_blank">
          <svg width="24px" height="24px" viewBox="7.086 -169.483 1277.149 1277.149"
               shape-rendering="geometricPrecision" text-rendering="geometricPrecision"
               image-rendering="optimizeQuality" xmlns="http://www.w3.org/2000/svg" fill="#000000">
            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
            <g id="SVGRepo_iconCarrier">
              ...
              <linearGradient id="a" gradientUnits="userSpaceOnUse" x1="1959.712" y1="737.107" x2="26066.213"
                              y2="737.107" gradientTransform="matrix(.0283 0 0 -.0283 248.36 225.244)">
                <stop offset="0" stop-color="#f8f6ef"></stop>
                <stop offset="1" stop-color="#e7e4d6"></stop>
              </linearGradient>
